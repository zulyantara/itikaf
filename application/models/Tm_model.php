...
{
    var $table = 'top_menu';
    var $column_order = array(null, 'tm_ket', 'tm_url'); //set column field database for datatable orderable
    var $column_search = array('tm_ket', 'tm_url'); //set column field database for datatable searchable
    var $order = array('tm_id' => 'desc'); // default order

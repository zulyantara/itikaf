...
{
    var $table = 'pages';
    var $column_order = array(null, 'pages_title'); //set column field database for datatable orderable
    var $column_search = array('pages_title'); //set column field database for datatable searchable
    var $order = array('pages_id' => 'desc'); // default order
    ...
    function get_detail_pages($where)
    {
        if (is_array($where))
        {
    ...
    public function get_pages($slug = FALSE)
    {
            ...
            $query = $this->db->get_where('pages', array('pages_slug' => $slug));

...
$kota_ket = isset($res_kota) ? ucwords($res_kota->kota_ket) : "";
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('cpanel_aktivasi'); ?>" class="btn btn-primary btn-sm btn-flat">List Calon Peserta</a>
                </div>
            </div>
            ...
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo site_url('cpanel_kota/simpan'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" name="simpan" value="<?php echo $btn; ?>" class="btn btn-primary btn-sm btn-flat">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>

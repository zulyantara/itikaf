    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">List Top Menu</h3>
                <div class="box-tools pull-right">
                    <div class="btn-group" role="group" aria-label="...">
                        <a href="<?php echo site_url('cpanel_tm/tambah_data'); ?>" class="btn btn-primary btn-flat btn-sm">Tambah Data</a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('cpanel_tm/ajax_list')?>",
            "type": "POST"
        },
...
function deleteItem(i,a)
{
    ...
    {
        window.location = "<?php echo site_url('cpanel_tm/hapus_data/'); ?>"+i;
    }
    return false;
}

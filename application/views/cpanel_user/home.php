            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <div class="btn-group" role="group">
                        <div class="btn-group" role="group">
                            <a href="<?php echo site_url('cpanel_user/tambah_data'); ?>" class="btn btn-primary btn-sm btn-flat">Tambah Data</a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('cpanel_user/ajax_list')?>",
            "type": "POST"
        },
...
function deleteItem(i,a)
{
    ...
    {
        window.location = "<?php echo site_url('cpanel_user/hapus_data/'); ?>"+i;
    }
    return false;
}

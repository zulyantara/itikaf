        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('cpanel_kota/tambah_data'); ?>" class="btn btn-primary btn-sm btn-flat">Tambah Data</a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('cpanel_kota/ajax_list')?>",
            "type": "POST"
        },
...
function deleteItem(i,a)
{
    ...
    {
        window.location = "<?php echo site_url('cpanel_kota/hapus_data/'); ?>"+i;
    }
    return false;
}
